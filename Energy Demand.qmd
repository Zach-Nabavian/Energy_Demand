...
-   My options included:
    ...
    -   Just build a model with hourly seasonality, since that has the strongest effect
...
-   I found [this academic journal article](https://www.sciencedirect.com/science/article/abs/pii/S0169207015001557) discussing forecasting for electricity demand

-   The journal uses a model that incorporates a cubic regression model incorporating temperature values

-   It does not incorporated prior values of energy demand
...
$$
\begin{align}
f(T_t) &= B_0 + B_1Trend + B_2M_t + B_3W_t + B_4H_t + B_5M_tH_t \\
&\quad + B_6Tt + B_7T_t^2 + B_8T_t^3 \\ 
...
-   Including recency terms did not seem to improve the model

# Notes

-   This model is not meant to be some revolutionary new forecast that's better than what the industry is already doing

-   There are definitely better forecasts for this dataset

-   This was meant as a learning exercise above all else

# Lessons Learned

-   Understanding what experts in the field are doing is more important than using the most cutting edge technology

-   I used the book [Forecasting: Principles and Practice](https://otexts.com/fpp3/) to help learn how to build these models in R
